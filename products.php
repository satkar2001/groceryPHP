...
>>>>>>> 33b0179299ff7e1b053578eb20a5bb7ffeb09f96:products.html
    <div class="container">
        <h1 class="heading"><span>All Products </span></h1>
         <div class="grid">
            ...
            <article>
                <img src="./images/himalayaghee.png" alt="">
                <div class="text">
                    <h3> HN ghee 500gm</h3>
                    <p>Rs 190</p>
                    <button>add to cart</button>
            ...
            <article>
                <img src="./images/parmesan.png" alt="">
                <div class="text">
                    <h3>parmesan cheese 50gm</h3>
                    <p>Rs.130</p>
                    <button>add to cart</button>
                </div>
            </article>
            <article>
                <img src="./images/curd.png" alt="">
                <div class="text">
                    <h3>amul masti curd</h3>
                    <p>Rs.50</p>
                    <button>add to cart</button>
                </div>
            </article>
            ...
            <article>
                ...
                <div class="text">
                    <h3>Salt</h3>
                    <p>Rs.20 per packet</p>
                    <button>Add to Cart</button>
                </div>
            </article>
            <article>
                <img src="./images/turmeric.png" alt="">
                <div class="text">
                    <h3>Turmeric</h3>
                    <p>Rs.50 per packet</p>
                    <button>Add to Cart</button>
            ...
            <article>
                <img src="./images/chillipow.png" alt="">
                <div class="text">
                    <h3>Chilli Powder</h3>
                    <p>Rs.70 per packet</p>
                    <button>Add to Cart</button>
                </div>
            </article>
            <article>
                ...
                <div class="text">
                    <h3>Coriander</h3>
                    <p>Rs.35 per packet</p>
                    <button>Add to Cart</button>
                </div>
            </article>
            <article>
                <img src="./images/jeera.png" alt="">
                <div class="text">
                    <h3>Jeera</h3>
                    <p>Rs.80 per packet</p>
                    <button>Add to Cart</button>
                </div>
            </article>
            <article>
                <img src="./images/bpepper.png" alt="">
                <div class="text">
                    <h3>Black Pepper</h3>
                    <p>Rs.100 per packet</p>
                    <button>Add to Cart</button>
                </div>
            </article>
            <article>
                <img src="./images/cdmom.png" alt="">
                <div class="text">
                    <h3>Cardamom</h3>
                    <p>Rs.120 per packet</p>
                    <button>Add to Cart</button>
                </div>
            </article>
            <article>
   ...
   <article>
                <img src="./images/cleancare.png" alt="" >
                <div class="text">
                    <h3>Tissue Paper</h3>
                    <p>800</p>
                    <button>Add to Cart</button>
   ...
   <article>
                <img src="./images/headandshoulders.png" alt="" >
                <div class="text">
                    <h3>Shampoo</h3>
                    <p>400</p>
                    <button>Add to Cart</button>
   ...
   <article>
            ...
            <article>
                <img src="./images/chicken-1.png" alt="chicken">
                <div class="text">
                    <h3>Chicken</h3>
                    <p>Rs. 400 per kg</p>
                    <button>Add to Cart</button>
